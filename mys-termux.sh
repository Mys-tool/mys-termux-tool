...
# variables
    ...
    setdir=$PWD
    version='mys-termux.sh V2.1'

# help
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    echo ""
    echo -e "Default Kullanım İçin Dosyayı ${lightgreen}sudo bash mys-termux.sh$tp"
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red Mysorfilox$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/Mysorfilox$tp"
    echo -e $cyan"    Instagram           $white":" $red @_barann.35$tp"
    echo -e "$cyan    Discord            $white : $red https://discord.io/Mys$tp"
    echo -e "$cyan    Tester             $white : $red Mys$tp"
    echo -e "$cyan    Developper         $white : $red https://github.com/Mysorfilox$tp"
    exit 0
...
echo -e "[${blink}${yellow}*${tp}]$blue Mys-Tool Programini Tercih Ettiginiz Icin Tesekkurler  {Mysorfilox} :)$tp"
exit 0
}
...
echo " ~~~~~~~~~~~~~~~~~~~~~ Mysorfilox Termux ~~~~~~~~~~~~~~~~~~~~~~~~~" 
        ...
        echo " [h] ✔ Help" 
        echo " [q] ✔ Exit"  
        echo -ne "\n${red}┌─[${tp}${USER}${yellow}@${blue}Mys-tool${red}]─[${green}./mys-termux.sh${red}] \n└──╼${yellow}$ ${tp}" ; read option
        echo ""
        ...
        case "$option" in
            ...
            while :; do
                ...
                echo -e "b-) Ana Menü"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-termux${red}]─[${green}./mys-termux.sh/PhoneInfoga${red}] \n└──╼${yellow}$ ${tp}" ; read input1
                if [[ $input1 = "1" ]] ; then
                echo -e "${green}[TR +${red}90${green}]${tp} +90 yazmadan ${blue}5312534783${tp} şeklinde giriniz"
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-termux${red}]─[${green}./mys-termux.sh/PhoneInfoga/TR${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
                ...
                echo -ne "\n${red}┌─[${tp}PhoneInfoga${yellow}@${blue}Mys-termux${red}]─[${green}./mys-termux.sh/PhoneInfoga/custom${red}] \n└──╼${yellow}$ ${tp}" ; read atkx
            ...
            q) 
                ...
                echo " Mys-termux Programini Tercih Ettiginiz Icin Tesekkurler {Mys-termux} !!" 
                echo ""
                exit 0
                ;;
        esac
